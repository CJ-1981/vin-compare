...
3. **Multi-Select Status Filter Dropdown with Dynamic Counts:**
...
4. **Interactive & Persisted Column Sorting:**
...
5. **Real-time Filtered Count in Column Headers:**
...
6. **Spacious Add & Batch Import Modal Window:**
